...
import (
	...
	"github.com/BTCGhostdag/BTCD/infrastructure/os/execenv"
	"github.com/BTCGhostdag/BTCD/infrastructure/os/limits"
	"github.com/BTCGhostdag/BTCD/infrastructure/os/signal"
	"github.com/BTCGhostdag/BTCD/infrastructure/os/winservice"
...
func (app *BTCDApp) main(startedChan chan<- struct{}) error {
	...
	if err != nil {
		log.Errorf("Unable to start BTCD: %+v", err)
		return err
	}

	defer func() {
		log.Infof("Gracefully shutting down BTCD...")
		...
		log.Infof("BTCDd shutdown complete")
	}()
