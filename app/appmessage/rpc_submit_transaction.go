...
// RPCTransaction is a BTCD transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a BTCD transaction input representation
...
// RPCScriptPublicKey is a BTCD ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a BTCD transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a BTCD outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a BTCD utxo entry representation meant to be used
// over RPC
