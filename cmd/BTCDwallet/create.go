...
import (
	...
	"github.com/BTCGhostdag/BTCD/cmd/BTCDwallet/libkaspawallet/bip32"
	"github.com/BTCGhostdag/BTCD/cmd/BTCDwallet/utils"
	"github.com/pkg/errors"

	"github.com/BTCGhostdag/BTCD/cmd/BTCDwallet/keys"
)
...
func create(conf *createConfig) error {
	...
	fmt.Printf("Notice the above is neither a secret key to your wallet " +
		"(use \"BTCDwallet dump-unencrypted-data\" to see a secret seed phrase) " +
		"nor a wallet public address (use \"BTCDwallet new-address\" to create and see one)\n\n")
