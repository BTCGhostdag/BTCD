...
import (
	...
	"github.com/BTCGhostdag/BTCD/domain/consensus/utils/virtual"
...
func (v *blockValidator) checkCoinbaseSubsidy(
	...
	for _, parent := range parents {
		...
		// The pruning proof ( https://github.com/BTCGhostdag/docs/blob/main/Reference/prunality/Prunality.pdf ) concludes
