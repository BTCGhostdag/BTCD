...
import (
	...
	"github.com/BTCGhostdag/BTCD/infrastructure/network/netadapter/server"
...
type grpcStream interface {
	Send(*protowire.BTCDdMessage) error
	Recv() (*protowire.BTCDdMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.BTCDdMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.BTCDdMessage) error {
