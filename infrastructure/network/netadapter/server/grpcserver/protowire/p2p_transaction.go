...
func (x *BTCDdMessage_Transaction) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "BTCDdMessage_Transaction is nil")
	}
	return x.Transaction.toAppMessage()
}

func (x *BTCDdMessage_Transaction) fromAppMessage(msgTx *appmessage.MsgTx) error {
