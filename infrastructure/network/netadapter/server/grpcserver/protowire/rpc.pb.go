...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether BTCD thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when BTCD is not synced.
	// That is because when BTCD isn't in sync with the rest of the network there's a high
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this BTCD initiated the connection
	...
	// The timestamp of when this peer connected to this BTCD
