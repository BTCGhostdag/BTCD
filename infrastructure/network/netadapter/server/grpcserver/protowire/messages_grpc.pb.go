...
type P2P_MessageStreamClient interface {
	Send(*BTCDdMessage) error
	Recv() (*BTCDdMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *BTCDdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*BTCDdMessage, error) {
	m := new(BTCDdMessage)
...
func (x *p2PMessageStreamServer) Send(m *BTCDdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*BTCDdMessage, error) {
	m := new(BTCDdMessage)
...
func (x *rPCMessageStreamClient) Send(m *BTCDdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*BTCDdMessage, error) {
	m := new(BTCDdMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *BTCDdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*BTCDdMessage, error) {
	m := new(BTCDdMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
