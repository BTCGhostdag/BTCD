...
func (x *BTCDdMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "BTCDdMessage_Addresses is nil")
	}
...
func (x *BTCDdMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
