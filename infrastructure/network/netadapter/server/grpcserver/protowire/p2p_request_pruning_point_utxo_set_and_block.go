...
func (x *BTCDdMessage_RequestPruningPointUTXOSet) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "BTCDdMessage_RequestPruningPointUTXOSet is nil")
	}
...
func (x *BTCDdMessage_RequestPruningPointUTXOSet) fromAppMessage(
