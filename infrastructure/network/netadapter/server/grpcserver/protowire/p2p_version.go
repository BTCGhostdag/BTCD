...
func (x *BTCDdMessage_Version) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "BTCDdMessage_Version is nil")
	}
...
func (x *BTCDdMessage_Version) fromAppMessage(msgVersion *appmessage.MsgVersion) error {
