...
func (x *BTCDdMessage_Reject) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "BTCDdMessage_Reject is nil")
	}
...
func (x *BTCDdMessage_Reject) fromAppMessage(msgReject *appmessage.MsgReject) error {
