...
import (
	...
	"github.com/BTCGhostdag/BTCD/util/network"
...
var (
	// DefaultAppDir is the default home directory for BTCD.
	DefaultAppDir = util.AppDir("BTCD", false)
...
// DefaultConfig returns the default BTCD configuration
