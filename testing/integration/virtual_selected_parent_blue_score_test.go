...
func TestVirtualSelectedParentBlueScoreAndVirtualDAAScore(t *testing.T) {
	...
	response, err := BTCD.rpcClient.GetVirtualSelectedParentBlueScore()
	if err != nil {
	...
	err = BTCD.rpcClient.RegisterForVirtualSelectedParentBlueScoreChangedNotifications(
	...
	err = BTCD.rpcClient.RegisterForVirtualDaaScoreChangedNotifications(
