...
import (
	...
	"github.com/BTCGhostdag/BTCD/domain/consensus/utils/utxo"
	...
	"github.com/BTCGhostdag/BTCD/domain/consensus/utils/transactionid"
...
func TestUTXOIndex(t *testing.T) {
	...
	err := BTCD.rpcClient.RegisterForUTXOsChangedNotifications([]string{miningAddress1}, func(
	...
	for i := 0; i < transactionAmountToSpend; i++ {
		...
		_, err = BTCD.rpcClient.SubmitTransaction(rpcTransaction, false)
		if err != nil {
	...
	utxosByAddressesResponse, err := BTCD.rpcClient.GetUTXOsByAddresses([]string{miningAddress1})
	if err != nil {
